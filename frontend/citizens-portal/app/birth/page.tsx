...
export default function BirthCertificate() {
  ...
  const handleAccept = () => {
    setModalOpen(false)
    router.push('/apply?type=birth&subtype=new')
  }
              ...
              <div className="rounded-[4px] border border-slate-200 bg-white/95 p-8 shadow-lg shadow-slate-900/5 backdrop-blur-xl">
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        title: "Child's Registration Details",
                        description:
                          'Full legal name, date of birth, and gender as recorded at the time of delivery.',
                      },
                      {
                        title: "Father's/Mother's Personal Info",
                        description:
                          'Valid government ID numbers, full names, and current residential addresses.',
                      },
                      {
                        title: 'Hospital Birth Record',
                        description:
                          'Official hospital notification number or a digital copy of the clinic discharge summary.',
                      },
                    ].map((item, idx) => (
